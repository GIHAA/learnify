...
const CourseInfo = () => {
  ...
  const [_, setEnrollments] = useState([]);
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          {payment ? (
            <div className=" w-full bg-white rounded shadow px-[20px] py-[40px]">
              <h2 className="text-[24px] leading-[29px] font-bold mb-[16px]">
                This course includes
              </h2>

              <div className="ml-10 mb-10 flex flex-col gap-2 text-[16px] leading-[24px]">
                <p className=" font-semibold">
                  {course.content ? course.content.length : "0 "} Chapters
                </p>
                ...
                <div className="flex flex-col gap-[8px]">
                  <p>
                    Last update on :{" "}
                    {course
                      ? new Date(course.updated_at).toLocaleDateString("en-CA")
                      : "0"}{" "}
                  </p>
                </div>
