...
// app.get('/auth/auth-service/health', (_, res) => res.status(200).json({ message: 'Auth service Up and Running' }));
app.get('/auth/health', (_, res) => res.status(200).json({ message: 'Auth service Up and Running' }));
