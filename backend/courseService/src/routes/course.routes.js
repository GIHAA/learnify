...
import { addCourse, getChartData , getAllCourses , getAllMyCourses ,  getOneCourse, removeCourse, updateCourse } from '@/controllers/course';
...
course.get('/chart-data', tracedAsyncHandler(getChartData));
